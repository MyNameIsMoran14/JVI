...
Нужно одно место, где основной пользователь (родственник, ведущий уход) видит все анализы пациента в динамике, историю визитов к гематологу и разговоры с AI-помощником. Анализ загружается одним действием: переслать фото или PDF боту. Помощник всегда знает актуальную картину болезни.
...
| Роль | Кто | Что делает |
| --- | --- | --- |
| editor (основной) | Родственник, ведущий уход | Загружает анализы, смотрит графики, спрашивает помощника, готовит вопросы к врачу |
| admin | Разработчик | Настраивает систему, исправляет распознавание, следит за бэкапами |
| viewer | Пациент, остальные родственники | Только просмотр |

**Критерии успеха MVP**

- Новый анализ появляется на графике меньше чем через 2 минуты после отправки фото боту.
- Основной пользователь находит ответ из прошлого разговора за 3 клика или одним поиском.
- Помощнику не нужно заново объяснять диагноз и лечение: он видит их в каждом чате.
- Перед визитом основной пользователь открывает готовый список вопросов к врачу.
...
- Пациент знает и согласен, что его анализы хранятся и обрабатываются AI. Для чужих пользователей понадобилось бы соблюдение 152-ФЗ — это вопрос к юристу.
...
| --- | --- | --- | --- |
| 0. Быстрый старт | 1 вечер | Проект в ChatGPT с инструкцией из раздела 7 и файлами анализов | Пользователю легче уже сейчас |
...
| 5. Полировка | Неделя 5 | Чат и поиск в Mini App, закрепление, бэкапы, CI/CD, тестирование с пользователем | MVP в проде |
...
- [ ] Создать бота в @BotFather, узнать telegram_id основного пользователя и свой
- [ ] Спросить у гематолога, какие показатели и пороги считаются тревожными
- [ ] Обсудить с пациентом и семьёй, что и как будет храниться
